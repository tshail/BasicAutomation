...
public class Multiplewindowhandle {
	...
	wait.until(ExpectedConditions.elementToBeClickable(By.xpath(".//*[@id='ctl00_MainContent_LoginUser_LoginButton']"))).click();
	
	
	wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='ctl00_MainContent_LoginUser_UserName']"))).sendKeys("shailesh");
	
	wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='ctl00_MainContent_LoginUser_Password']"))).sendKeys("Jibe@123");
	
	wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='ctl00_MainContent_LoginUser_LoginButton']"))).sendKeys(Keys.ENTER);
	
	
	driver.get("http://192.168.1.102/JIBE/purchase/InvertyItems.aspx");
	wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='ctl00_MainContent_ddlPOType']"))).isEnabled();
	wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='ctl00_MainContent_ddlPOType']"))).sendKeys("Management PO");
	
//	wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='ctl00_MainContent_ddlReqsnType']"))).isEnabled();
	
//	wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='ctl00_MainContent_ddlReqsnType']"))).isEnabled();
    wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath(".//*[@id='ctl00_MainContent_ddlReqsnType']")));
	driver.findElement(By.xpath(".//*[@id='ctl00_MainContent_ddlReqsnType']")).sendKeys("Spare");
...
/*	 @Test(priority=2)
	 public void width () throws InterruptedException{
		 System.setProperty("webdriver.chrome.driver","C:\\Users\\Reshma\\Downloads\\IE driver\\IEDriverServer.exe");
